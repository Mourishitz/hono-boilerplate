const messages: { [key: string]: { [key: string]: string } } = {
  ...
  pt: {
    ...
    "The :field field must be a valid JWT token":
      "O campo :field deve ser um token JWT válido",
    "The :field field must be a valid URL":
      "O campo :field deve ser um URL válido",
    "The :field field and :otherField field must be the same":
      "Os campos :field e :otherField devem ser iguais",
    "The :field field and :otherField field must be different":
      "Os campos :field e :otherField devem ser diferentes",
    "The :field field must have at least :min characters":
      "O campo :field deve conter no mínimo :min caracteres",
    ...
    "The selected :field is not in :values":
      "O :field selecionado não está em :values",
    "The :field field must be at least :min":
      "O campo :field deve ter pelo menos :min",
    "The :field field must not be greater than :max":
      "O campo :field não deve ser maior que :max",
    ...
    "The :field field must have :digits decimal places":
      "O campo :field deve ter :digits casas decimais",
    ...
    "The :field field must be :expectedValue":
      "O campo :field deve ser :expectedValue",
    ...
    "The :field field must be a date after :otherField":
      "O campo :field deve ser uma data após :otherField",
    "The :field field must be a date after or same as :otherField":
      "O campo :field deve ser uma data após ou igual a :otherField",
    "The :field field must be a date before :otherField":
      "O campo :field deve ser uma data antes de :otherField",
    "The :field field must be a date before or same as :otherField":
      "O campo :field deve ser uma data antes ou igual a :otherField",
